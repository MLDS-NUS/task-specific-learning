...
if os.path.exists(weights_file):
    ...
    weights_file_old = f'{datapath}/weights/weights_as_mse/E1_as_dr0.0_{randomseed}_{nodes}wts.npz'
    print("Loading old weights", weights_file_old)
    weights1 = np.load(weights_file_old, allow_pickle=True)['weights']
    model.set_weights(weights1)
else:
